...
export const TRANSACTIONS_TABLE_DEF: TableDefinition = {
  ...
  schema: [
    ...
    { 
      ...
      label: 'Service Plan', 
      type: 'Enum', 
      enumCategory: 'TransactionTemplateID', 
    ...
    { 
      ...
      type: 'EnumList', 
      enumCategory: 'Related TransactionParties', 
      enumValueSource: 'displayName',
      required: false,
      isVirtual: false 
    },
    ...
    { 
      ...
      label: 'Add Vendor(s)', 
      type: 'EnumList', 
      enumCategory: 'Related TransactionContacts', 
      enumValueSource: 'displayName',
      required: false,
      isVirtual: false
    },
    ...
    { name: 'Additional Property Info', label: 'Additional Property Info', type: 'LongText', required: false, isVirtual: false },
    { name: 'Agreements Describe', label: 'Agreements Describe', type: 'LongText', required: false, isVirtual: false },
    ...
    { name: 'MLS_Description', label: 'MLS Description', type: 'LongText', required: false, isVirtual: false },
    ...
    { name: 'Other_Liens_Description', label: 'Other Liens Description', type: 'LongText', required: false, isVirtual: false },
    ...
    { name: 'Leased_Items', label: 'Leased Items', type: 'LongText', required: false, isVirtual: false },
    { name: 'Supplemental_Info', label: 'Supplemental Info', type: 'LongText', required: false, isVirtual: false },
    ...
    { 
      ...
      type: 'EnumList', 
      enumCategory: 'SelectedFormInstances', 
      enumValueSource: 'displayName',
    ...
    { 
      ...
      type: 'EnumList', 
      enumCategory: 'AllRelatedProperties', 
      enumValueSource: 'displayName',
      required: false,
      isVirtual: false
    },
    ...
    { 
      ...
      type: 'EnumList', 
      enumCategory: 'Related FormInstances', 
      enumValueSource: 'displayName',
      formula: 'REF_ROWS("FormInstance", "Transaction_ID")',
      hidden: true,
      isVirtual: true
    ...
    { 
      ...
      type: 'EnumList', 
      enumCategory: 'RelatedProperties', 
      enumValueSource: 'displayName',
